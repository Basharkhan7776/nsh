...
pub struct Capabilities {
    ...
    /// extensions.
    #[prost(string, repeated, tag = "2")]
    pub advanced_extension_type_urls: ::prost::alloc::vec::Vec<
...
pub mod capabilities {
    ...
    pub struct SimpleExtension {
        ...
        pub type_variation_keys: ::prost::alloc::vec::Vec<
            ::prost::alloc::string::String,
        >,
    }
}
...
pub struct ParameterizedType {
    #[prost(
        oneof = "parameterized_type::Kind",
        tags = "1, 2, 3, 5, 7, 10, 11, 12, 13, 14, 16, 17, 19, 20, 29, 32, 21, 22, 23, 24, 25, 27, 28, 30, 31, 33"
    )]
...
pub mod parameterized_type {
    ...
    pub struct ParameterizedList {
        ...
        pub r#type: ::core::option::Option<
            ::prost::alloc::boxed::Box<super::ParameterizedType>,
        >,
        #[prost(uint32, tag = "2")]
        pub variation_pointer: u32,
        #[prost(enumeration = "super::r#type::Nullability", tag = "3")]
    ...
    pub enum Kind {
        ...
        #[prost(message, tag = "20")]
        IntervalDay(super::r#type::IntervalDay),
        #[prost(message, tag = "29")]
...
pub struct DerivationExpression {
    #[prost(
        oneof = "derivation_expression::Kind",
        tags = "1, 2, 3, 5, 7, 10, 11, 12, 13, 14, 16, 17, 19, 20, 29, 32, 21, 22, 23, 24, 25, 27, 28, 30, 31, 33, 34, 35, 36, 37, 38, 39"
    )]
...
pub mod derivation_expression {
    ...
    pub struct ExpressionFixedChar {
        ...
        pub length: ::core::option::Option<
            ::prost::alloc::boxed::Box<super::DerivationExpression>,
        >,
        #[prost(uint32, tag = "2")]
        pub variation_pointer: u32,
        #[prost(enumeration = "super::r#type::Nullability", tag = "3")]
    ...
    pub struct ExpressionDecimal {
        ...
        >,
        #[prost(message, optional, boxed, tag = "2")]
        pub precision: ::core::option::Option<
            ::prost::alloc::boxed::Box<super::DerivationExpression>,
        >,
        #[prost(uint32, tag = "3")]
        pub variation_pointer: u32,
    ...
    pub struct IfElse {
        #[prost(message, optional, boxed, tag = "1")]
        pub if_condition: ::core::option::Option<
            ::prost::alloc::boxed::Box<super::DerivationExpression>,
        >,
        #[prost(message, optional, boxed, tag = "2")]
        pub if_return: ::core::option::Option<
            ::prost::alloc::boxed::Box<super::DerivationExpression>,
        >,
        #[prost(message, optional, boxed, tag = "3")]
        pub else_return: ::core::option::Option<
            ::prost::alloc::boxed::Box<super::DerivationExpression>,
        >,
    }
    #[allow(clippy::derive_partial_eq_without_eq)]
    ...
    pub mod unary_op {
        ...
        impl UnaryOpType {
            ...
            pub fn as_str_name(&self) -> &'static str {
                match self {
                    UnaryOpType::Unspecified => "UNARY_OP_TYPE_UNSPECIFIED",
                    UnaryOpType::BooleanNot => "UNARY_OP_TYPE_BOOLEAN_NOT",
                }
            }
            /// Creates an enum from field names used in the ProtoBuf definition.
            pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
    ...
    pub struct BinaryOp {
        ...
        pub op_type: i32,
        #[prost(message, optional, boxed, tag = "2")]
        pub arg1: ::core::option::Option<
            ::prost::alloc::boxed::Box<super::DerivationExpression>,
        >,
        #[prost(message, optional, boxed, tag = "3")]
        pub arg2: ::core::option::Option<
            ::prost::alloc::boxed::Box<super::DerivationExpression>,
        >,
    }
    ...
    pub mod binary_op {
        ...
        impl BinaryOpType {
            ...
            pub fn as_str_name(&self) -> &'static str {
                match self {
                    BinaryOpType::Unspecified => "BINARY_OP_TYPE_UNSPECIFIED",
                    BinaryOpType::Plus => "BINARY_OP_TYPE_PLUS",
                    BinaryOpType::Minus => "BINARY_OP_TYPE_MINUS",
                    BinaryOpType::Multiply => "BINARY_OP_TYPE_MULTIPLY",
                    BinaryOpType::Divide => "BINARY_OP_TYPE_DIVIDE",
                    BinaryOpType::Min => "BINARY_OP_TYPE_MIN",
                    BinaryOpType::Max => "BINARY_OP_TYPE_MAX",
                    BinaryOpType::GreaterThan => "BINARY_OP_TYPE_GREATER_THAN",
                    BinaryOpType::LessThan => "BINARY_OP_TYPE_LESS_THAN",
                    BinaryOpType::And => "BINARY_OP_TYPE_AND",
                    BinaryOpType::Or => "BINARY_OP_TYPE_OR",
                    BinaryOpType::Equals => "BINARY_OP_TYPE_EQUALS",
                    BinaryOpType::Covers => "BINARY_OP_TYPE_COVERS",
                }
            }
            /// Creates an enum from field names used in the ProtoBuf definition.
            pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
    ...
    pub struct ReturnProgram {
        ...
        #[prost(message, optional, boxed, tag = "2")]
        pub final_expression: ::core::option::Option<
            ::prost::alloc::boxed::Box<super::DerivationExpression>,
        >,
    }
...
pub mod function_signature {
    ...
    pub mod final_arg_variadic {
        ...
        impl ParameterConsistency {
            ...
            pub fn as_str_name(&self) -> &'static str {
                match self {
                    ParameterConsistency::Unspecified => {
    ...
    pub struct Scalar {
        ...
        pub final_variable_behavior: ::core::option::Option<
            scalar::FinalVariableBehavior,
        >,
    }
    ...
    pub struct Aggregate {
        ...
        pub final_variable_behavior: ::core::option::Option<
            aggregate::FinalVariableBehavior,
        >,
    }
        ...
        impl WindowType {
            ...
            pub fn as_str_name(&self) -> &'static str {
                match self {
                    ...
                    WindowType::Streaming => "WINDOW_TYPE_STREAMING",
                    WindowType::Partition => "WINDOW_TYPE_PARTITION",
                }
            }
            /// Creates an enum from field names used in the ProtoBuf definition.
            pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        ...
        impl Type {
            ...
            pub fn as_str_name(&self) -> &'static str {
                match self {
                    ...
                    Type::WebAssembly => "TYPE_WEB_ASSEMBLY",
                    Type::TrinoJar => "TYPE_TRINO_JAR",
                }
            }
            /// Creates an enum from field names used in the ProtoBuf definition.
            pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
